...
parser.add_argument('--model_path', type=str, default="/home/hpc/iwai/iwai119h/UGTST/repo-UGTST/repo1/models/source/best_model.pth")
parser.add_argument('--data_root', type=str, default="/home/hpc/iwai/iwai119h/UGTST/repo-UGTST/data_preprocessed/PROMISE12")
parser.add_argument('--save_dir', type=str, default="/home/hpc/iwai/iwai119h/UGTST/repo-UGTST/repo1/outputs/target_training")
parser.add_argument('--pseudo_dir', type=str, default="/home/hpc/iwai/iwai119h/UGTST/repo-UGTST/data_preprocessed/PROMISE12/slices_pseudo")
parser.add_argument('--active_txt', type=str, default="/home/hpc/iwai/iwai119h/UGTST/repo-UGTST/data_preprocessed/PROMISE12/slices_pseudo/selected.txt")
parser.add_argument('--val_cases', type=str, default="/home/hpc/iwai/iwai119h/UGTST/repo-UGTST/data_preprocessed/PROMISE12/target_val.txt")
parser.add_argument('--train_cases', type=str, default="/home/hpc/iwai/iwai119h/UGTST/repo-UGTST/data_preprocessed/PROMISE12/target_train.txt")
